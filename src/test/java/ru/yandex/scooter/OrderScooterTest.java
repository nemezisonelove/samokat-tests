...
public class OrderScooterTest extends BaseTest {
    ...
    public static Object[][] getOrderFormData() {
        return new Object[][] {
                {OrderButton.TOP_BUTTON, "Фанфурик", "Лудмурик", "Мытищи", "880055533535", "сутки", "black", "1"},
                {OrderButton.BOTTOM_BUTTON, "Папич",
                        "Авантюра",
                        "Мытищи, ул. Шараповская, дом 1 квартира 90",
                        "+79012231415", "четверо суток", "black",
                        "Жду самокат"
                                + "Звоните заранее"
                },
        };
